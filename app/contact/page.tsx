...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Get in touch with Interop Digital Solutions Ltd. Located at Trinity Mall, Ikeja, Lagos. Call ++234-906-053-1418 or email info@interopdigitalsolutions.com. Book a consultation today.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Get in touch with Interop Digital Solutions Ltd. Located at Trinity Mall, Ikeja, Lagos. Call ++234-906-053-1418 or email info@interopdigitalsolutions.com. Book a consultation today.';
