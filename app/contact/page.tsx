    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-br from-primary-600 via-primary-500 to-orange-600 overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 overflow-hidden pointer-events-none">
          <svg className="absolute top-24 right-10 w-16 h-16 text-white/20 animate-float" viewBox="0 0 100 100">
            <circle cx="50" cy="50" r="40" fill="currentColor" />
          </svg>
          <svg className="absolute bottom-24 left-20 w-20 h-20 text-yellow-400/15 animate-float-delayed" viewBox="0 0 100 100">
            <polygon points="50,10 90,90 10,90" fill="currentColor" />
          </svg>
          <svg className="absolute top-1/2 left-1/3 w-12 h-12 text-white/25 animate-float" viewBox="0 0 100 100">
